# Self hosting with docker compose, caddy, borg and git.

**What is this?** A very simple, easy to maintain self-hosting setup with decent security, decent reliability (backups, monitoring) and the whole thing is versioned in git and your password manager. Tradeoffs are disclaimed below.
...
## Services included in this example (adapt to your needs)
...
## Appendix: create a SSH key that can only access one repo on Github
